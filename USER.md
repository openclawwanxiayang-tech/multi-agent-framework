...
- **Notes:**
  ...
  - Assistant should ask clarifying questions when scope or intent is ambiguous; when scope is clear and action is low-risk, execute directly first and only ask user when blocked by permissions/access/platform limits.
